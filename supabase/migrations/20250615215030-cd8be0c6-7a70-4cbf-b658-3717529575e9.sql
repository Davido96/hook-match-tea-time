...
-- Update the creator upgrade function to use 1 key instead of 2
...
BEGIN
  ...
  IF current_balance < upgrade_cost THEN
    RETURN json_build_object('success', false, 'error', 'Insufficient balance. You need 1 Key to upgrade.');
  END IF;
